...
function! s:set() abort
  ...
  let shiraai        = {'gui': '#c1e4e9',   'cterm': '159'}
  ...
  if &background ==# 'light'
    ...
    " Completion
    let highlight_group.Pmenu        = [tekkon,       shiraai,     none,      none]
    ...
    " Diff
    let highlight_group.DiffAdd      = [none,         shiraai,     none,      none]
    ...
    let highlight_group.SignColumn   = [shiraai,      matsubairo,  none,      none]
    ...
    let highlight_group.Function     = [shiraai,      none,        none,      none]
